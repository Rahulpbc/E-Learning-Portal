...
<div class="navbar navbar-default navbar-static-top" style="background-color:#1E88E5;">
    ...
    <li class="nav-item active">
        <a class="nav-link active" style="color:white;" data-toggle="tab" href="#panel1" role="tab"><h3>MOCK TESTS</h3></a>
    </li>
	</ul>
  ...
  <div class="row-fluid">
    <div class="col-sm-3">
        ...
        $results = mysqli_query($db, $query);
         ...
         <h3><a href="questions.php">Test 1</a></h3>
  ...
  <div class="modal fade" id="myModal" role="dialog">
    ...
    <div class="col-sm-3">
        ...
        $results = mysqli_query($db, $query);
         ...
         <h3><a href="questions.php">Test 2</a></h3>
    ...
    <div class="col-sm-3">
      <?php
        ...
        $results = mysqli_query($db, $query);
         ...
         <h3><a href="questions.php">Test 3</a></h3>
    ...
    <div class="modal-dialog">
     ...
     <?php
        ...
        $results = mysqli_query($db, $query);
         ...
         <h3><a href="questions.php">Test 4</a></h3>
